...
A restricted shell is a shell that restricts some of the commands or "block" the environment variables like SHELL,PATH,USER. Some restricted shells blocks commands with / or the redirecting outputs like >, >>.
